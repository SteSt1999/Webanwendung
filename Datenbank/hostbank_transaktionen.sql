...
CREATE TABLE `transaktionen` (
  ...
  `Empfänger_Bank` varchar(50) DEFAULT NULL,
...
INSERT INTO `transaktionen` VALUES ('stefan.stump',1,1,-50000,'hostbank','julia.holzmann'),('julia.holzmann',0,2,50000,NULL,NULL),('stefan.stump',5,3,-7500,NULL,NULL),('stefan.stump',42,4,1234,NULL,NULL),('julia.holzmann',3,3,-1212,NULL,NULL),('otto.ben',0,2,123456789,'',NULL),('otto.ben2',2,1,-123456789,'hostbank','otto.ben');
...
-- Dump completed on 2018-10-23 11:44:14
